...
qaAdminRoutes.patch("/questions/:id/show", requireAuth, requireRole("ADMIN"), requireCsrf, validate(questionIdParamSchema), qaAdminController.showQuestion);
...
qaAdminRoutes.patch("/answers/:id/show", requireAuth, requireRole("ADMIN"), requireCsrf, validate(answerIdParamSchema), qaAdminController.showAnswer);
