...
} from "../validations/shipping.admin.validation.js";
...
shippingRoutes.put(
  ...
  shippingAdminController.updateZone,
);
shippingRoutes.delete(
  ...
  shippingAdminController.removeZone,
);
...
shippingRoutes.post(
  ...
  shippingAdminController.createMethod,
);
shippingRoutes.put(
  "/methods/:id",
  requireAuth,
  ...
  shippingAdminController.updateMethod,
);
shippingRoutes.delete(
  "/methods/:id",
  requireAuth,
  ...
  requireCsrf,
  validate(idParamSchema),
  shippingAdminController.removeMethod,
);
...
shippingRoutes.post(
  ...
  shippingAdminController.createRule,
);
shippingRoutes.put(
  "/rules/:id",
  requireAuth,
  ...
  shippingAdminController.updateRule,
);
shippingRoutes.delete(
  "/rules/:id",
  requireAuth,
  ...
  requireCsrf,
  validate(idParamSchema),
  shippingAdminController.removeRule,
);
